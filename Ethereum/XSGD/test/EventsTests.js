...
async function run_tests(newToken, accounts) {
  ...
  it('et000 should check MinterConfigured event', async function() {
    let increaseMinterAllowance = await token.increaseMinterAllowance(minterAccount, amount, { from: masterMinterAccount });
    checkMinterConfiguredEvent(increaseMinterAllowance, minterAccount, amount);
  });
  ...
  it('et002 should check Burn/Transfer events', async function () {
    // Need additional 1 allowance because when you mint your entire allowance, you become a non minter.
  ...
  it('et003 should check MinterRemoved event', async function () {
    await token.increaseMinterAllowance(minterAccount, amount, { from: masterMinterAccount });
    let minterRemovedEvent = await token.decreaseMinterAllowance(minterAccount, amount, {from: masterMinterAccount});
  ...
  it('et011 should check Approval event', async function () {
    let approval = await token.increaseAllowance(arbitraryAccount2, amount, {from: arbitraryAccount});
  ...
  it('et016 should check Transfer event in transferFrom', async function () {
    await token.increaseMinterAllowance(minterAccount, amount, { from: masterMinterAccount });
    await token.mint(arbitraryAccount, amount, {from: minterAccount});
    await token.increaseAllowance(arbitraryAccount2, amount, {from: arbitraryAccount});
