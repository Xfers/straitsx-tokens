...
async function run_tests(newToken, accounts) {
  ...
  it('ept006 should decreaseMinterAllowance while paused', async function () {
    ...
    await token.decreaseMinterAllowance(minterAccount, amount, { from: masterMinterAccount });
    var notAMinter = [
  ...
  it('ept030 should increaseMinterAllowance when masterMinter is blacklisted', async function () {
  ...
  it('ept032 should increaseMinterAllowance when minter is blacklisted', async function () {
  ...
  it('ept033 should decreaseMinterAllowance when masterMinter is blacklisted', async function() {
    await token.increaseMinterAllowance(minterAccount, amount, { from: masterMinterAccount });
    await token.blacklist(masterMinterAccount, { from: blacklisterAccount });
    var customVars = [
      { 'variable': 'isAccountMinter.minterAccount', 'expectedValue': true },
  ...
  it('ept034 should decreaseMinterAllowance when minter is blacklisted', async function() {
    await token.increaseMinterAllowance(minterAccount, amount, { from: masterMinterAccount });
    await token.blacklist(minterAccount, { from: blacklisterAccount });
    var customVars = [
      { 'variable': 'isAccountMinter.minterAccount', 'expectedValue': true },
