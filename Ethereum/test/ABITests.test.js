...
async function run_tests(newToken, accounts) {
    ...
    it('abi004 FiatToken pause() is public', async function () {
        ...
        var tx = new Tx({
            nonce: await web3.eth.getTransactionCount(pauserAccount),
    ...
    it('abi040 Blacklistable constructor is not a function', async function () {
        ...
        await expectRevert(sendSignedTransaction(raw));
    });
    ...
    it('abi025 setOwner is internal', async function () {
        ...
        var tx = new Tx({
            nonce: await web3.eth.getTransactionCount(tokenOwnerAccount),
            gasPrice: web3.utils.toHex(web3.utils.toWei('20', 'gwei')),
            gasLimit: 100000,
            to: token.address,
            value: 0,
